...
The motivation of the text is to provide a story mode for the lecture note \cite{zqhNA}, explaning the motivation and the background. Many appreciations to the book \cite{BriggsMultigrid}, which make me understand the multigrid technic well.
