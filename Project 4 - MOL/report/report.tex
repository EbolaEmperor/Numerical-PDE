...
where
\begin{equation*}
    A_k=\frac{40}{k^2\pi^2}\left[-\sin\left(\frac{9k\pi}{20}\right)+2\sin\left(\frac{k\pi}{2}\right)-\sin\left(\frac{11k\pi}{20}\right)\right].
\end{equation*}

Plot the true solution by summing up the first $20$ items in the infinite series (1) as follows.
