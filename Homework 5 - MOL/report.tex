...
\begin{align*}
    &(A\mathbf{w}^p)_j = \gamma_1e^{2\pi\mathbf{i}pjh} + \gamma_2e^{2\pi\mathbf{i}p(j-1)h} + \gamma_3e^{2\pi\mathbf{i}p(j-2)h}\\
    =& e^{-2\pi\mathbf{i}ph}\left[(\mu^2-2\mu)(\cos(2\pi ph)-1)-\mathbf{i}\mu\sin(2\pi ph)\right]w^p_j.
\end{align*}
...
\begin{equation*}
    z_p=e^{-2\pi\mathbf{i}ph}\left[(\mu^2-2\mu)(\cos(2\pi ph)-1)-\mathbf{i}\mu\sin(2\pi ph)\right].
\end{equation*}

Now suppose $\mu\in[0,2]$, we have
\begin{align*}
    &1+z_p \\
